using Tyuiu.BerezovskayaGO.Sprint0.Task7.V0.Lib;
namespace Tyuiu.BerezovskayaGO.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнила: Березовская Г. О. | АСОиУб-24-1";
            Console.WriteLine("****************************************************************************");
            ...
            {
                int[] resulArray = DataServise.AdditionArray(arrayNums1, arrayNums2);
